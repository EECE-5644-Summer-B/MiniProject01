...
This repository contains a Jupyter Notebook used to sanitize the transaction data for Cobblestone Gifts, a fictional gift shop based in the United Kingdom, and doing business primarily within Western Europe. Several entries are malformed or missing important information. This notebook exhibits the basics of database manipulation, and provides in its auxiliary files (`Mini_project_one_finding_summary.pdf`, `clean_online_retail.csv`, `cleaning_log.md`) a summary of the aforementioned sanitized data, a raw database of such, and an explanation of the various choices made, respectively.
